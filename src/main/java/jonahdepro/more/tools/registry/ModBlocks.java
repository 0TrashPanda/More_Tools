...
public class ModBlocks {
    ...
    public static void registeritems() {
            ...
            Registry.register(Registry.ITEM, new Identifier("moretools", "tin_ore"), new BlockItem(TIN_ORE, new Item.Settings().group(MoreTools.GROUP)));
            Registry.register(Registry.BLOCK, new Identifier("moretools", "tin_block"),TIN_BLOCK);
            Registry.register(Registry.ITEM, new Identifier("moretools", "tin_block"), new BlockItem(TIN_BLOCK, new Item.Settings().group(MoreTools.GROUP)));    
            Registry.register(Registry.BLOCK, new Identifier("moretools", "raw_tin_block"),RAW_TIN_BLOCK);
            Registry.register(Registry.ITEM, new Identifier("moretools", "raw_tin_block"), new BlockItem(RAW_TIN_BLOCK, new Item.Settings().group(MoreTools.GROUP)));    
            Registry.register(Registry.BLOCK, new Identifier("moretools", "mythril_ore"),MYTHRIL_ORE);
            Registry.register(Registry.ITEM, new Identifier("moretools", "mythril_ore"), new BlockItem(MYTHRIL_ORE, new Item.Settings().group(MoreTools.GROUP)));
